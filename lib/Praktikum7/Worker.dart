...
class WorkerController extends GetxController {
  ...
  @override
  void onInit() {
    // Menanggil worker setiap kali count berubah
    ever(count, (_) => print("ever: Count changed to $count"));

    // Menjalankan worker hanya satu kali saat count berubah untuk pertama kalinya
    once(count, (_) => print("once: Count changed to $count"));

    // Menanggil worker setiap 2 detik, hanya jika ada perubahan pada count
